    ...
    public function handle()
    {
        Competitor::all()
            ->each(function ($competitor) {
                $this->line('Getting competitor snapshot for '.$competitor->name);

                $url = 'https://maps.googleapis.com/maps/api/place/details/json?place_id='.$competitor->place_location.'&key='.config('reporting.api_key');
                $client = new Client();
